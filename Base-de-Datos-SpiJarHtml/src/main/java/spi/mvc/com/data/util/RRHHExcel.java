...
@Component("/views/RRHH/rrhh.xlsx")
public class RRHHExcel extends AbstractXlsxView{
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		box3.setCellValue("LISTA DE LOS RECURSOS HUMANOS DE LOS SPI");
		
		Row filadatos=hoja.createRow(5);
		String[] columnasdatosspi = {"ID","Nombres","Apellidos","Cédula","Zona", "SPI", "Cargo","Estado del funcionario","Unidad","Número telefónico","Email","Dirección de domicilio"};
		...
		for (RRHH registrosrrhh : listarrhh) {
			...
			filadatos.createCell(8).setCellValue(registrosrrhh.getUnidad());
