...
@Controller
@RequestMapping("/views/admin/equipoasignacion")
public class AsignacionEquipoController {
	...
	//ASIGNACION DE FUNCIONARIO ////
		...
		public String listarFuncionario(Model model) {
			...
			return "/views/admin/equipoasignacion/Listarasignacionequipo";
		}
		////////////////////
	...
	return "/views/admin/equipoasignacion/formularioasignacionequipo";
	}
	...
	return "redirect:/views/admin/equipoasignacion/"; }
